...
namespace EventOrg
{
    public class ListInfo : InfoElement
    {
        public static List<ListInfo> pnkteGrundlage()
        {
            ...
            infoList.Add(new ListInfo { infoID = "cater", antwort = "", aktiv = true });
            infoList.Add(new ListInfo { infoID = "LP_caterGetr", antwort = "", aktiv = true });
            ...
            infoList.Add(new ListInfo { infoID = "extraTisch", antwort = "", aktiv = true });
            ...
            infoList.Add(new ListInfo { infoID = "extraStuhl", antwort = "", aktiv = true });
            ...
            infoList.Add(new ListInfo { infoID = "extraKüUt", antwort = "", aktiv = true });
            ...
            infoList.Add(new ListInfo { infoID = "extraGesch", antwort = "", aktiv = true });
            ...
            infoList.Add(new ListInfo { infoID = "extraKühlw", antwort = "", aktiv = true });
            ...
            infoList.Add(new ListInfo { infoID = "extraDeko", antwort = "", aktiv = true });
            ...
            infoList.Add(new ListInfo { infoID = "extraBühn", antwort = "", aktiv = true });
            ...
            infoList.Add(new ListInfo { infoID = "extraAbsp", antwort = "", aktiv = true });
            ...
            infoList.Add(new ListInfo { infoID = "musikBandDJ", antwort = "", aktiv = true });
            ...
            infoList.Add(new ListInfo { infoID = "musikTechn", antwort = "", aktiv = true });
            infoList.Add(new ListInfo { infoID = "musikTechnStil", antwort = "", aktiv = true });
            infoList.Add(new ListInfo { infoID = "musikTechnSpezWunsch", antwort = "", aktiv = true });
            infoList.Add(new ListInfo { infoID = "einlKart", antwort = "", aktiv = true });
            ...
            infoList.Add(new ListInfo { infoID = "einlEmail", antwort = "", aktiv = true });
            ...
            infoList.Add(new ListInfo { infoID = "einlFB", antwort = "", aktiv = true });
            ...
            infoList.Add(new ListInfo { infoID = "einlG", antwort = "", aktiv = true });
            infoList.Add(new ListInfo { infoID = "einlGNamen", antwort = "", aktiv = true });
            infoList.Add(new ListInfo { infoID = "einlGText", antwort = "", aktiv = true });
